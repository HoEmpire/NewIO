...
public:
  ...
  bool readData1Byte(uint8_t* buffer, int length, double timeout);
...
public:
  ...
  ////////////////////////////////////////////////////////////////////////////////
  bool openPort(const bool block = false);
  ...
  /// @return or true
  ////////////////////////////////////////////////////////////////////////////////
  bool setBaudRate(const int baudrate, const bool block = false);
