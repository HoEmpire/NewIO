...
////////////////////////////////////////////////////////////////////////
    ...
    // struct Motion::JointConfig _cfg6(14,-1,4096,203,4096,0);
    // struct Motion::Joint joints_cfg6(_cfg6);
    // servo_test.addJoint("left_ankle_roll", joints_cfg6);
    //
    // struct Motion::JointConfig _cfg5(13,-1,4096,156,4096,0);
    // struct Motion::Joint joints_cfg5(_cfg5);
    // servo_test.addJoint("left_ankle_pitch", joints_cfg5);
    //
    // struct Motion::JointConfig _cfg4(12,1,4096,157,4096,0);
    // struct Motion::Joint joints_cfg4(_cfg4);
    // servo_test.addJoint("left_knee", joints_cfg4);
    //
    // struct Motion::JointConfig _cfg3(11,-1,4096,242,4096,0);
    // struct Motion::Joint joints_cfg3(_cfg3);
    // servo_test.addJoint("left_hip_yaw", joints_cfg3);
    //
    // struct Motion::JointConfig _cfg2(10,-1,4096,202,4096,0);
    // struct Motion::Joint joints_cfg2(_cfg2);
    // servo_test.addJoint("left_hip_roll", joints_cfg2);
    //
    // struct Motion::JointConfig _cfg1(9,1,4096,202,4096,0);
    // struct Motion::Joint joints_cfg1(_cfg1);
    // servo_test.addJoint("left_hip_pitch", joints_cfg1);
